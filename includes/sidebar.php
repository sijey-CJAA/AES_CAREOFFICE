...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-label">CARS ASSESSMENTS</div>
        <a href="<?= BASE_URL ?>/pages/cars_sessions.php" class="nav-item <?php echo ($current_page == 'cars_sessions.php' || $current_page == 'cars_assessment.php') ? 'active' : ''; ?>" data-tooltip="CARS Dashboard">
        ...
        <a href="<?= BASE_URL ?>/pages/cars_norms.php" class="nav-item <?php echo ($current_page == 'cars_norms.php') ? 'active' : ''; ?>" data-tooltip="Norm Tables">
