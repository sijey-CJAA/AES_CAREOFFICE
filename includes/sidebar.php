...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-label" style="margin-top: 1rem;">Guidance Records</div>
        <a href="view_assessments.php" class="nav-item <?php echo $current_page == 'view_assessments.php' ? 'active' : ''; ?>">
            ...
            Guidance Office Assessment Records
        </a>
        <a href="view_cases.php" class="nav-item <?php echo $current_page == 'view_cases.php' ? 'active' : ''; ?>">
            ...
            Guidance Office Case Register
        </a>

        <div class="nav-label" style="margin-top: 1rem;">System</div>
        <a href="view_deleted.php" class="nav-item <?php echo $current_page == 'view_deleted.php' ? 'active' : ''; ?>">
