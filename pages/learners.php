...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-controls">
            ...
            <button class="control-btn btn-primary" onclick="document.getElementById('add-student-section').style.display = document.getElementById('add-student-section').style.display === 'none' ? 'block' : 'none'">+ Add New Learner</button>
        </div>
    </div>
