...
<body>
    ...
    <div class="main-wrapper">
        ...
        <main class="main-content">
            <div class="page-header-container">
                <h1 class="page-title">Graduates</h1>
                ...
                <div class="table-responsive" style="overflow-x: auto;">
                    <table class="data-table" id="dataTable" style="min-width: max-content;">
                        ...
                        <tbody id="learner-table-body">
                            ...
                            <tr>
                                <td colspan="12" style="text-align: center; color: var(--text-muted); padding: 2rem;">No graduates found.</td>
                            </tr>
                            <?php else: ?>
    ...
    <script>
        ...
        function loadLearners() {
            ...
            fetch(BASE_URL + '/api/api_get_graduates_filtered.php?' + params.toString())
                .then(res => res.json())
                .then(data => {
